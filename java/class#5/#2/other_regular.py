...
driver.get("http://142.132.145.204:1102/")
...
for r in range(number):
    ...
    time.sleep(20)
    fabric=driver.find_element(By.ID, "PageContent_GridView_DXPEForm_efnew_tabs_DropList_DDD_lbAvailable_0_LBI1T2") #1
    time.sleep(5)
...
#    time.sleep(time_data) #the time period you want to stop the invoice
    ...
    WebDriverWait(driver, 30).until(EC.visibility_of_element_located((By.ID, "PageContent_GridView_DXPEForm_efnew_tabs_DropList_B-1Img"))).click()
    time.sleep(20)
    fabric1=driver.find_element(By.ID, "PageContent_GridView_DXPEForm_efnew_tabs_DropList_DDD_lbAvailable_0_LBI2T2") #2
    time.sleep(5)
    ...
    WebDriverWait(driver, 30).until(EC.visibility_of_element_located((By.ID, "PageContent_GridView_DXPEForm_efnew_tabs_DropList_B-1Img"))).click()
    time.sleep(20)
    fancy=driver.find_element(By.ID, "PageContent_GridView_DXPEForm_efnew_tabs_DropList_DDD_lbAvailable_0_LBI1T2") #1
    time.sleep(8)
    ...
    WebDriverWait(driver, 30).until(EC.visibility_of_element_located((By.ID, "PageContent_GridView_DXPEForm_efnew_tabs_DropList_B-1Img"))).click()
    time.sleep(20)
    fabric2=driver.find_element(By.ID, "PageContent_GridView_DXPEForm_efnew_tabs_DropList_DDD_lbAvailable_0_LBI2T2") #2
    time.sleep(5)
