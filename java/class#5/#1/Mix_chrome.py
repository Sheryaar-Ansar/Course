...
# fabric_entry=input("EMBROIDERED FARBICS  (6001) INVOICE ENTRY NUMBER:- ")
# fabric_amount=input("TOTAL BILL AMOUNT OF EMBROIDERED FARBICS  (6001):-")
fancy_entry=input("EMBROIDERED FARBICS ( 20 YDS ) (5801) INVOICE ENTRY NUMBER:- ")
fancy_amount=input("TOTAL BILL AMOUNT OF EMBROIDERED FARBICS ( 20 YDS ) (5801) :-")
...
driver.get("http://erp.cherrystechnology.com:2013")
...
for r in range(number):
    ...
    # search.click()
    # search.send_keys("EMBROIDERED FARBICS ( 30 YDS ) (5804)")
    # time.sleep(3)
    # fabric=driver.find_element(By.ID, "PageContent_GridView_DXPEForm_efnew_tabs_DropList_DDD_lbAvailable_0_LBI5T2")
    # time.sleep(5)
    ...
    search=driver.find_element(By.ID, "PageContent_GridView_DXPEForm_efnew_tabs_DropList_DDD_lbAvailable_0_LBFE_I")
    search.click()
    search.send_keys("EMBROIDERED FARBICS ( 20 YDS ) (5801)")
    time.sleep(3)
    fancy=driver.find_element(By.ID, "PageContent_GridView_DXPEForm_efnew_tabs_DropList_DDD_lbAvailable_0_LBI6T2")
    time.sleep(5)
